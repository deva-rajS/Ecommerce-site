...
addCart.forEach(function (cart) {
  cart.addEventListener("click", function (e) {
    ...
    let html = `<div class="flex text-sm w-[90%] h-20 mx-5 py-2 gap-x-5 border-b-2 close">
    <img src="${itemimage}" alt="img" />
    <h2 class="grid w-32 sm:w-auto">${itemname}<span class="item-price">${itemprice}</span></h2>
